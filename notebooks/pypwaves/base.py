    ...
    def print_table(self):
        for key, value in sorted(self.__dict__.items()):
            if type(value) != dict:
                ...
                print ("{:<20} {}".format(key, value.keys()))
                #print ("{0} {1}".format(key, value.keys()))
...
class Waves(object):
    ...
    def __init__(self, header, pulse_record):    
        ...
        for key in sample_records.keys():
            ...
            # TODO: to verify - signed or unsigned?, other implementations do not apply scale and offset
            # see ln 130 https://github.com/PulseWaves/PulseWaves/blob/30e3daf8a71a838822aad4c9a1f922a05e3677c5/src/pulsereadwaves_raw.cpp
            duration_anchor = struct.unpack("=l", wavebinary.read(sample_record.bits_anchor//8))[0]
            duration_anchor = duration_anchor * sample_record.scale_anchor + sample_record.offset_anchor
            ...
            for sample_num in range(num_samples): 
                ...
                # TODO: to verify 
                sample = struct.unpack("=B", wavebinary.read(sample_record.bits_per_sample//8))[0]
